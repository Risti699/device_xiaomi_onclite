...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/permissions/privapp-permissions-google-p-carriersettings.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/privapp-permissions-google-p-carriersettings.xml
